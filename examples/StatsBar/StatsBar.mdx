...
import * as StatsBarStories from './StatsBar.stories';
import StatsBar from './StatsBar';

<Meta of={StatsBarStories} />

# StatsBar Documentation

This document provides information about the StatsBar component.
